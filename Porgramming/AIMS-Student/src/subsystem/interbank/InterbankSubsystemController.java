...
/**
 * This is the class for the bank system.
 * <br>@author ADMIN
 *
 */
public class InterbankSubsystemController {
  ...
  /**
   * This is the method to pay for order.
   * <br>@param card  the credit card used {@link entity.payment.CreditCard}
   * <br>@param amount  the amount of the money to pay
   * <br>@param contents  the content of the transaction
   * <br>@return PaymentTransaction  the transaction {@link entity.payment.PaymentTransaction}
   */
  public PaymentTransaction payOrder(CreditCard card, int amount, String contents) {
    ...
    String responseText = interbankBoundary.query(
        Configs.PROCESS_TRANSACTION_URL, generateData(requestMap));
    MyMap response = null;
    try {
  ...
  private PaymentTransaction makePaymentTransaction(MyMap response) {
    ...
    CreditCard card = new CreditCard((String) transcation.get("cardCode"), 
        (String) transcation.get("owner"), Integer.parseInt((String) 
            transcation.get("cvvCode")), (String) transcation.get("dateExpired"));
