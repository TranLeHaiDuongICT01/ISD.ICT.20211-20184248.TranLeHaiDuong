...
/**
 * This is the class handler for the home screen.
 * <br>@author ADMIN
 *
 */
public class HomeScreenHandler extends BaseScreenHandler implements Initializable {
  ...
  /**
   * This is the method to set the logo and cart image to diplay on the screen.
   */
  ...
  /**
   * This is the method to add media to the list item in the cart if customer choose to add to cart.
   * <br>@param items
   */
  @SuppressWarnings("unused")
  public void addMediaHome(@SuppressWarnings("rawtypes") List items) {
    @SuppressWarnings("rawtypes")
