...
/**
 * This is the class handler for the media screen.
 * <br>@author ADMIN
 *
 */
...
public class MediaHandler extends FxmlScreenHandler {
  ...
  public MediaHandler(String screenPath, Media media, 
      HomeScreenHandler home) throws SQLException, IOException {
    super(screenPath);
    this.media = media;
    this.home = home;
    addToCartBtn.setOnMouseClicked(event -> {
      try {
        ...
        // if media already in cart then we will increase the
        // quantity by 1 instead of create the new cartMedia
        CartMedia mediaInCart = home.getbController().checkMediaInCart(media);
        if (mediaInCart != null) {
          mediaInCart.setQuantity(mediaInCart.getQuantity() + 1);
        } else {
          CartMedia cartMedia = new CartMedia(media, cart, 
              spinnerChangeNumber.getValue(), media.getPrice());
  ...
  private void setMediaInfo() throws SQLException {
    ...
    spinnerChangeNumber.setValueFactory(new SpinnerValueFactory
